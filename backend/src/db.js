  ...
  db.transaction(() => {
    ...
    db.exec(`
      INSERT INTO actors (
        ...
        special_skills, titles, status, summary, photo, gallery, showreel, contact, rating, rating_count,
...
const insertActor = db.prepare(`
  INSERT INTO actors (
    id, slug, initials, name, role, city, age_range, height, weight, hair_color, languages, skills, genres, special_skills, titles,
    ...
    @id, @slug, @initials, @name, @role, @city, @ageRange, @height, @weight, @hairColor, @languages, @skills, @genres, @specialSkills, @titles,

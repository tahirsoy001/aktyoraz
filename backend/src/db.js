...
export function toDbActor(actor) {
  return {
    ...
    featuredOrder: actor.featuredOrder ? Math.min(99, Math.max(1, Number(actor.featuredOrder))) : null,
    homeOrder: actor.homeOrder ? Math.min(99, Math.max(1, Number(actor.homeOrder))) : null,
